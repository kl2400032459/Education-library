const RAW_RESOURCES = [
    { id: 1, title: 'Introduction to Algorithms', subject: 'Computer Science', department: 'Engineering', type: 'Textbook', rating: 4.8, description: 'A comprehensive guide to fundamental algorithms and data structures. Includes examples in Python and Java. Covered topics: Sorting, Searching, Graphs, Dynamic Programming.', tags: ['Algorithms', 'CS', 'Data Structures', 'Python'], thumb: '📘', uploader: 'Dr. John Smith', uploadDate: '2023-08-15', downloads: 1245, size: '15 MB', pages: 420, contentPreview: 'Chapter 1: Getting Started with Algorithms. An algorithm is a step-by-step procedure for solving a problem...', pdfUrl: 'mock-algo.pdf' },
    { id: 2, title: 'Calculus Vol 1', subject: 'Mathematics', department: 'Science', type: 'Notes', rating: 4.5, description: 'First semester calculus lecture notes covering limits, derivatives, and introduction to integration.', tags: ['Math', 'Calculus', 'Derivatives'], thumb: '📐', uploader: 'Prof. Alan Turing', uploadDate: '2023-09-01', downloads: 850, size: '5 MB', pages: 120, contentPreview: 'Lecture 1: The concept of a limit. We say that the limit of f(x) as x approaches c is L...', pdfUrl: 'mock-calc.pdf' },
    { id: 3, title: 'Physics Fundamentals', subject: 'Physics', department: 'Science', type: 'Video', rating: 4.2, description: 'Video lectures on classical mechanics, Newton\'s laws, and basic thermodynamics.', tags: ['Physics', 'Mechanics', 'Thermodynamics'], thumb: '⚛️', uploader: 'Dr. Marie Curie', uploadDate: '2023-10-12', downloads: 640, size: '1.2 GB', pages: 0, contentPreview: 'Video Overview: In this series, we explore the fundamental laws that govern the physical universe...', videoUrl: 'mock-video-url' },
    { id: 4, title: 'React Advanced Patterns', subject: 'Web Dev', department: 'Engineering', type: 'Video', rating: 4.9, description: 'Advanced react architecture, custom hooks, context API, and performance optimization techniques.', tags: ['React', 'Frontend', 'JavaScript'], thumb: '💻', uploader: 'Sarah Developer', uploadDate: '2024-01-05', downloads: 2100, size: '850 MB', pages: 0, contentPreview: 'In this course, we dive deep into advanced React patterns such as Compound Components and Render Props.', videoUrl: 'mock-react-video' },
    { id: 5, title: 'Organic Chemistry', subject: 'Chemistry', department: 'Science', type: 'Textbook', rating: 4.1, description: 'Detailed organic chemistry mechanisms, stereochemistry, and spectroscopy.', tags: ['Chemistry', 'Organic'], thumb: '🧪', uploader: 'Dr. Walter White', uploadDate: '2023-11-20', downloads: 420, size: '22 MB', pages: 650, contentPreview: 'Chapter 1: Structure and Bonding. Organic chemistry is the study of carbon compounds...', pdfUrl: 'mock-chem.pdf' },
    { id: 6, title: 'World History Notes', subject: 'History', department: 'Arts', type: 'Notes', rating: 4.6, description: 'Summary notes for world history midterms. Covers WW1, WW2, and the Cold War eras.', tags: ['History', 'World War', 'Cold War'], thumb: '🌍', uploader: 'Mr. History Buff', uploadDate: '2024-02-10', downloads: 950, size: '3 MB', pages: 45, contentPreview: 'Topic 1: Causes of World War I. Militarism, Alliances, Imperialism, and Nationalism (MAIN)...', pdfUrl: 'mock-history.pdf' },
...
const INITIAL_RESOURCES = RAW_RESOURCES.map((res, index) => {
    if (index < 25) {
...
export const getStoredResources = () => {
    // Validate that we have exactly 25 active resources in the cache. 
    // If not, it forces a reinitialization of localStorage to fix existing clients.
    initializeData('libraryItems', INITIAL_RESOURCES, (data) => {
